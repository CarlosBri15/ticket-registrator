...
export const CompanyModeBanner = ({
  ...
  return (
    <div
      className={`bg-brand rounded-lg p-4 flex items-center justify-between gap-4 shadow-sm`}
    ...
    >
      ...
      <div className="flex items-center gap-2 shrink-0">
        <button
          type="button"
          onClick={onDetail}
          className={`text-xs font-semibold bg-white/10 hover:bg-white/20 text-white px-3 py-1.5 rounded transition-all flex items-center gap-1.5`}
        >

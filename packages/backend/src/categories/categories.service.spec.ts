...
describe('CategoriesService', () => {
    ...
    describe('findAllByOrganization', () => {
        it('should return an array of categories', async () => {
            ...
            const result = [{ id: '1', name: 'Cat 1', description: 'Desc', organizationId: orgId }];
    ...
    describe('createDefaultFromSystem', () => {
        it('should copy system categories to organization', async () => {
            ...
            expect(mockRepository.createMany).toHaveBeenCalledWith([
                { name: 'Cat 1', description: 'Desc 1', organizationId: orgId, isSystem: false },
                { name: 'Cat 2', description: 'Desc 2', organizationId: orgId, isSystem: false },
            ]);
        });
